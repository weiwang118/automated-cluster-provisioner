...
| <a name="input_fleet_config_path"></a> [fleet_config_path](#input\_fleet\_config\_path) | Path to the fleet version configuration file in the repository. Note: This file must reside in the repository and branch specified by source_of_truth_repo and source_of_truth_branch. | `string` | `"fleet-version-config.csv"` | no |
